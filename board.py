    ...
    def getProtections(self, piece, row, col, team, grid):
        ...
        if (piece == "pond"):
            if (self.team == "white"):
                ...
                if (row == 6):
                    if (col >= 0 and col < 7):
                        if (grid[row-1][col+1].team == "white" or grid[row-1][col+1].piece == None):
                ...
                if (row == 1):
                    if (col >= 0 and col < COLS - 1):
                        if (grid[row+1][col+1].team == "black" or grid[row+1][col+1].piece == None):
                            moves.append([row+1, col+1])
                    if (col > 0 and col <= COLS - 1):
                        if (grid[row+1][col-1].team == "black" or grid[row+1][col-1].piece == None):
                            moves.append([row+1, col-1])
        ...
        ##########################################
            ...
            if team == "white":
                ...
                while (row > 0):
                    ...
                    if (grid[row][col].piece == None or grid[row][col].team == "white"):
                        moves.append([row, col])
                    if (grid[row][col].team == "white" or grid[row][col].team == "black"):
                        break
                row = copy_row
            ...
            if team == "white":
                if (row > 0 and col > 0):
                    if (grid[row-1][col-1].team == "white" or grid[row-1][col-1].piece == None):
                        moves.append([row-1, col-1])
                if (row > 0):
                    if (grid[row-1][col].team == "white" or grid[row-1][col].piece == None):
                        moves.append([row-1, col])
                    
                if (col > 0):
                    if (grid[row][col-1].team == "white" or grid[row][col-1].piece == None):
                ...
                if (row > 0 and col > 0):
                    if (grid[row-1][col-1].team == "black" or grid[row-1][col-1].piece == None):
                        moves.append([row-1, col-1])
                if (row > 0):
                    if (grid[row-1][col].team == "black" or grid[row-1][col].piece == None):
                        moves.append([row-1, col])
                    
                if (col > 0):
                    if (grid[row][col-1].team == "black" or grid[row][col-1].piece == None):
                        moves.append([row, col-1])
...
######################################################################################################################################
    ...
    def InCheckMoves(self, defending_team):
        ...
        if (defending_team == "white"):
            movable_pieces = [] # holds Square Object
            move = []   # holds corresponding move as a list --> index of move matches index of movable_pieces
            for row in range(ROWS):
                for col in range(COLS):
                    ...
                    for move in piece_moves:
                        ...
                        if copygrid[self.whiteKingLoc[0][self.whiteKingLoc[1]]].blackprotected == False:
                            movable_pieces.append(save_initial)
                            move.append([move[0], move[1]])

            self.white_movable = movable_pieces
            ...
            for row in range(ROWS):
                for col in range(COLS):
                    ...
                    for move in piece_moves:
                        ...
                        if self.grid[row][col].piece == "king":
                            kingrow = move[0]
                            kingcol = move[1]
                            self.loadProtections2(copygrid)
                            if copygrid[kingrow][kingcol].whiteprotected == False:
                                movable_pieces.append(save_initial)
                                move.append([move[0], move[1]])
                        else:
                            save_initial = copy.deepcopy(copygrid[row][col])
                            ...
                            copygrid[row][col] = Square(row, col)
                            self.loadProtections2(copygrid)
                            if copygrid[self.blackKingLoc[0]][self.blackKingLoc[1]].blackprotected == False:
                                movable_pieces.append(save_initial)
                                move.append([move[0], move[1]])
            
            self.black_movable = movable_pieces
